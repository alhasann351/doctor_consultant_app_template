...
class Languages extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
        'en_US': {
          ...
          'new_update_notifications': 'New & update',
        ...
        'bn_BD': {
          ...
          'gallery': 'গ্যালারি',
          'submit': 'জমা দিন',
          'my_section': 'আমার বিভাগ',
          'my_appointment': 'আমার অ্যাপয়েন্টমেন্ট',
          'add_review': 'রিভিউ দিন',
          'review': 'আপনার রিভিউ এখানে যোগ করুন...',
          'your_rate': 'আপনার অভিজ্ঞতা যোগ করুন',
          'appointment_cancel': 'অ্যাপয়েন্টমেন্ট বাতিল',
          'my_reviews': 'আমার রিভিউ',
          'setting_section': 'সেটিং বিভাগ',
          'notifications': 'নোটিফিকেশন',
          'email_notifications': 'ইমেল বিজ্ঞপ্তি',
          'general_notifications': 'সাধারণ বিজ্ঞপ্তি',
          'new_update_notifications': 'নতুন ও আপডেট',
          'booking_notifications': 'বুকিং',
          'languages': 'ভাষা',
          'policy_section': 'নীতি বিভাগ',
        ...
        'hi_IN': {
          ...
          'gallery': 'गैलरी',
          'submit': 'सबमिट',
          'my_section': 'मेरा अनुभाग',
          'my_appointment': 'मेरी नियुक्ति',
          'add_review': 'समीक्षा लिखें',
          'review': 'अपनी समीक्षा यहां जोड़ें...',
          'your_rate': 'अपना अनुभव जोड़ें',
          'appointment_cancel': 'नियुक्ति रद्द करें',
          'my_reviews': 'मेरी समीक्षाएँ',
          'setting_section': 'सेटिंग अनुभाग',
          'notifications': 'अधिसूचना',
          'email_notifications': 'ईमेल सूचनाएँ',
          'general_notifications': 'सामान्य सूचनाएँ',
          'new_update_notifications': 'नया और अपडेट',
          'booking_notifications': 'बुकिंग',
          'languages': 'भाषाएँ',
          'policy_section': 'नीति अनुभाग',
