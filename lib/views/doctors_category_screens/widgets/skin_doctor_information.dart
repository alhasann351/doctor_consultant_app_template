...
class SkinDoctorInformation extends StatefulWidget {
  const SkinDoctorInformation({super.key});

  @override
  State<SkinDoctorInformation> createState() => _SkinDoctorInformationState();
}

class _SkinDoctorInformationState extends State<SkinDoctorInformation> {
                    ...
                    children: [
                      ...
                      Positioned(
                        ...
                        child: RoundedButton(
                          ...
                          onTap: () {
                            /*Get.toNamed(RoutesName.bookingSkinDoctorsScreens,
                                arguments: {
