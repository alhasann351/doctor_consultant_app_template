...
class EyeDoctorInformation extends StatefulWidget {
  const EyeDoctorInformation({super.key});

  @override
  State<EyeDoctorInformation> createState() => _EyeDoctorInformationState();
}

class _EyeDoctorInformationState extends State<EyeDoctorInformation> {
                    ...
                    children: [
                      ...
                      Positioned(
                        ...
                        child: RoundedButton(
                          ...
                          onTap: () {
                            Get.toNamed(RoutesName.bookingEyeDoctorsScreens,
                                arguments: {
