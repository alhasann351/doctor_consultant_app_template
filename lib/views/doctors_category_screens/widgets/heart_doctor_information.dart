...
class HeartDoctorInformation extends StatefulWidget {
  ...
  @override
  State<HeartDoctorInformation> createState() => _HeartDoctorInformationState();
}

class _HeartDoctorInformationState extends State<HeartDoctorInformation> {
                      ...
                      children: [
                        ...
                        Positioned(
                          ...
                          child: RoundedButton(
                            ...
                            onTap: () {
                              Get.toNamed(RoutesName.heartDoctorBooking,
                                  arguments: {
